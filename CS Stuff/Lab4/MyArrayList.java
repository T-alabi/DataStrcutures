public class MyArrayList<E> implements MyList<E> {
  ...
  public static void main(String[] args) { 
    ...
    // for loop to run this code 5 times 
  for (int j = 0; j < 5; j++){

    // add 4 elements not counting time
    for (int i = 1; i < 5; i++)
    myArrayList.add(i);
    ...
    System.out.println("List after removal: " + myArrayList);
      ...
      time = end-begin; //this code the time interval it took
       System.out.println("It took: " + time+ " nanoseconds to delete 1 elements on average from list ");

       // find calcs for me
       sum = sum  + (time/4);
       myArrayList.clear();;// clears list for next call
       

  }
  System.out.println("It took " + sum + " total nancoseconds to run this 5 times, average " + sum/5);
