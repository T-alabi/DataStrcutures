        ...
        for(int j = 0; j <5; j++){
         ...
         for (int i = 1; i < 5; i++) {
          ...
          for (int i = 0; i < 3; i++) {
            ...
            ", head element: " + myLinkedList.head.element +
            ", head element next: " + ((myLinkedList.head.next != null)? myLinkedList.head.next.element.toString(): "null") + ", tail element: " + myLinkedList.tail.element +
            ", tail element next: " + ((myLinkedList.tail.next != null)? myLinkedList.tail.next.element.toString(): "null") +
            ", size: " + myLinkedList.size + "\n");
}
       // find calcs for me
       sum = sum  + ((time/4)/4);
       myLinkedList.clear();;// clears list for next call
        }
